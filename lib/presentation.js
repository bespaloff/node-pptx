        ...
        for (let key in content) {
            if (content.hasOwnProperty(key)) {
                ...
                if (ext === '.xml' || ext === '.rels') {
                    ...
                    let xml = ''
                    try {
                        xml = builder.buildObject(content[key]);
                    } catch (e) {
                        xml = `<?xml version="1.0" encoding="utf-16"?><properties xmlns="http://www.imanage.com/work/xmlschema">
                        <documentid>Active!379478.1</documentid>
                        <senderid>AUTOUSER</senderid>
                        <senderemail></senderemail>
                        <lastmodified>2022-10-11T09:28:38.0000000+02:00</lastmodified>
